...
const PaperTint: React.FC = () => (
  <Pane name="tint" style={{ zIndex: 250 }}>
    <Rectangle bounds={WORLD_BOUNDS} pathOptions={{ stroke: false, fillColor: '#f8f7f3', fillOpacity: 1 }} interactive={false} pane="tint" />
  </Pane>
);
  ...
  return (
    <div ref={rootRef} className="relative">
      <div className="flex justify-between items-end mb-2">
        <h3 className="font-serif italic text-[13px] text-muted">{label}</h3>
        {selected && (
          <button
  ...
  return (
    <div className="flex h-full w-full bg-parchment overflow-hidden">
      ...
      <div className="w-full max-w-[20rem] md:w-80 shrink-0 m-2 md:m-4 md:mr-3 p-4 md:p-5 flex flex-col gap-6 overflow-y-auto bg-parchment border border-border/60 rounded-sm">
        <div>
          <h2 className="font-serif text-xl text-ink pb-3 border-b border-border/60">Filtri della mappa</h2>
        </div>
        
        <div>
          <h3 className="font-serif italic text-[13px] text-muted mb-3">Regione</h3>
        ...
        <div>
          <h3 className="font-serif italic text-[13px] text-muted mb-3">
      ...
      <div className="flex-1 relative z-0 m-4 ml-0 rounded-sm overflow-hidden border border-border/60">
        ...
        <div className="absolute bottom-6 right-6 bg-parchment border border-border/60 p-4 z-[1000] rounded-sm text-xs pointer-events-none w-48">
          {hasActiveFilter ? (
            <>
              <h4 className="font-serif italic text-[13px] text-muted mb-3">Filtro attivo</h4>
            ...
            <>
              <h4 className="font-serif italic text-[13px] text-muted mb-3">Densità iscrizioni</h4>
              <div
          ...
          <h4 className="font-serif italic text-[13px] text-muted mb-3">Regione (bordo)</h4>
