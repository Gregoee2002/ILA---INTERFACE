...
al materiale epigrafico. La sottosezione 5.4 presenta la sezione
numismatica, dedicata alle monete e alle gemme relative al culto e
affiancata più di recente al catalogo epigrafico, e nella sottosezione
5.5 si illustrano infine gli strumenti di ricerca. Infine, nella sezione
6 si propongono alcune considerazioni finali e le prospettive di
...
Su questa stessa logica di verifica si fonda anche uno strumento di
controllo più recente, pensato per rispondere in maniera sistematica,
e non caso per caso, alla domanda di quanto il testo già trascritto
nel corpus diverga effettivamente dall'edizione a stampa di
riferimento. Poiché il livello di testo digitale ricavato dalla
digitalizzazione del volume rende in modo affidabile le porzioni in
inglese ma restituisce il greco come una sequenza di caratteri privi
di senso --- l'effetto tipico di un font non correttamente mappato in
fase di digitalizzazione --- non era possibile confrontare direttamente
il corpus con quel livello di testo per le porzioni in lingua greca,
che sono proprio quelle di maggiore interesse filologico. Si è
pertanto costruita una seconda lettura, indipendente dalla prima, che
isola sulla pagina digitalizzata i soli blocchi di testo greco ---
distinguendoli da quelli in inglese sulla base di tratti tipografici
quali la presenza di cifre o segni interni alla parola e l'uso non
iniziale della lettera maiuscola --- e li sottopone a un
riconoscimento ottico dedicato al greco antico, per poi ricomporre la
pagina intera a partire dalle due fonti, la lettura originaria per
l'inglese e quella dedicata per il greco.

Le due letture così ottenute --- quella derivata dal solo livello di
testo e quella arricchita dal riconoscimento dedicato al greco ---
vengono confrontate fra loro prima ancora di essere confrontate con il
corpus, e la collazione riporta come confermata soltanto la porzione
di testo su cui le due letture concordano: un accorgimento che riduce
il rischio, altrimenti concreto, di scambiare per una corrispondenza
autentica un errore di riconoscimento ottico condiviso dalle due
fonti. Applicata sistematicamente alle voci corrispondenti
dell'edizione a stampa, questa procedura ha permesso di stabilire, per
la prima volta su base quantitativa e non per campionatura, che la
grande maggioranza delle voci già confrontabili coincide, integralmente
o in altissima proporzione, con il testo a stampa di riferimento,
contenendo così un'ipotesi di partenza --- che una quota rilevante del
corpus portasse un errore di trascrizione non ancora individuato ---
che un confronto sistematico ha permesso di respingere.
...
A questa stessa informazione, raccolta voce per voce, si è affiancata
più di recente una lettura complementare, pensata non per il singolo
intervento ma per l'andamento complessivo del lavoro editoriale. Una
prima vista aggrega, per l'intero corpus e articolata per area
geografica, quanti dei campi previsti dalla scheda risultino
effettivamente compilati, quale sia lo stato editoriale raggiunto da
ciascuna voce e a chi essa sia stata assegnata, restituendo un quadro
sintetico dell'avanzamento del lavoro che altrimenti resterebbe
ricostruibile solo scorrendo il corpus voce per voce. Una seconda
vista, complementare alla prima, inverte il punto di osservazione e
riporta, scheda per scheda, quali fra i requisiti previsti --- un
campo bibliografico ancora da completare, un ruolo editoriale non
assegnato, un rimando privo di verifica --- risultino non ancora
soddisfatti, con la possibilità di filtrare l'elenco per tipo di
requisito, area geografica, responsabile e stato, e di esportarlo in
un formato tabellare per un lavoro di revisione organizzato al di
fuori dell'interfaccia stessa. Anche in questo caso, la scelta di
rendere sistematicamente visibile ciò che manca, anziché lasciarlo
emergere solo in occasione della singola revisione, risponde allo
stesso principio di trasparenza già più volte richiamato in questo
lavoro: un requisito non ancora soddisfatto resta segnalato come tale,
non nascosto in attesa che qualcuno se ne accorga per caso.

\screenshotplaceholder{6.5cm}{Confronto tra testo a stampa e trascrizione ottenuta tramite riconoscimento ottico}

\screenshotplaceholder{7cm}{Vista di avanzamento del corpus, con i campi compilati per area geografica}

\screenshotplaceholder{7cm}{Vista delle mancanze, con i requisiti non soddisfatti filtrati per scheda}
...
fonti letterarie sulla divinità, descritta nella sottosezione 5.3; una
sezione numismatica, dedicata alle monete e alle gemme relative al
culto e descritta nella sottosezione 5.4; e una sezione di ricerca
avanzata, descritta più diffusamente nella sottosezione 5.5. Ogni
scheda descrittiva è corredata, ove disponibile,
...
La mappa interattiva su cui si fonda la sezione geografica è stata
inoltre arricchita di un livello aggiuntivo di contesto, pensato per
collocare le attestazioni del corpus entro il tessuto insediativo
dell'Anatolia romana anziché presentarle come punti isolati su uno
sfondo altrimenti muto: agli zoom intermedi compaiono, accanto ai siti
già rappresentati nel corpus, anche i principali centri antichi della
regione privi di attestazione diretta, distinti graficamente da questi
ultimi e utili soltanto a orientare la lettura geografica, non a
suggerire un'attestazione che non esiste. La base cartografica stessa
privilegia il rilievo del territorio alla toponomastica amministrativa
moderna, con i toponimi antichi resi nello stesso carattere impiegato
nel resto dell'interfaccia, in modo che la mappa si presenti come un
livello di lettura coerente con quello testuale, piuttosto che come
una sovrapposizione a uno strumento cartografico pensato per altri
scopi.

\screenshotplaceholder{8cm}{Vista d'insieme dell'elenco delle epigrafi con filtri applicati}

\screenshotplaceholder{8cm}{Visualizzazione geografica delle attestazioni su mappa interattiva, con i centri antichi di contesto agli zoom intermedi}
...
All'interno della scheda descrittiva di ciascuna epigrafe, le
informazioni che eccedono la lettura del solo testo iscritto sono
riunite sotto un'unica intestazione, denominata morfologia cultuale,
articolata in quattro rubriche fra loro complementari: la funzione del
monumento (votiva, funeraria, onoraria, e così via), il lessico
cultuale attestato nell'edizione filologica della voce, raggruppato
per famiglia lessicale secondo la marcatura descritta nella sezione 3,
le divinità e i rispettivi epiteti attestati nella scheda, cui è
dedicata la sottosezione 5.2, e infine l'apparato iconografico,
oggetto del resto di questa sottosezione. Il registro propriamente
onomastico --- nomi propri, patronimici, cariche, e i riferimenti a
personaggi della casa imperiale --- resta invece ancorato alla lettura
del testo dell'iscrizione descritta nella sezione 2, di cui costituisce
parte integrante, piuttosto che essere isolato in un indice separato:
una distinzione che riflette la differenza di natura fra un dato
interpretativo e comparabile su scala di intero corpus, quale è per
l'appunto la morfologia cultuale, e un dato che appartiene innanzitutto
alla lettura filologica della singola voce.
...
\subsection{La sezione numismatica}

Al catalogo epigrafico si è affiancata più di recente una sezione
dedicata alla documentazione numismatica e glittica relativa al culto
di Men, tratta dal volume dell'edizione a stampa di riferimento
specificamente dedicato a monete e gemme. Si è scelto di trattare
questo materiale come una sezione autonoma, e non come una
sotto-categoria del catalogo epigrafico esistente, perché una moneta
non è semplicemente un'iscrizione su un supporto diverso, ma un
oggetto la cui unità di descrizione pone un problema che il materiale
epigrafico non conosce: la distinzione fra il tipo monetale ---
l'insieme di scelte iconografiche e testuali che caratterizza un'intera
emissione, riconducibile a una coppia di conii --- e il singolo
esemplare che di quel tipo costituisce una testimonianza materiale fra
le molte possibili. Si è scelto di far coincidere la scheda descrittiva
con il tipo, non con l'esemplare, in accordo con la scelta editoriale
già operata dall'edizione a stampa di riferimento: gli esemplari
concretamente noti restano registrati all'interno della medesima
scheda, con le proprie misure individuali, senza però duplicare per
ciascuno l'intera descrizione del tipo che rappresentano.

Questa distinzione ha richiesto un ulteriore adattamento della
rappresentazione delle epigrafi descritta nella sezione 2: mentre
un'iscrizione ha un unico testo, una moneta ha per costituzione due
facce --- dritto e rovescio --- ciascuna delle quali può portare una
propria legenda, una propria composizione figurata e un proprio stato
di conservazione, indipendenti l'una dall'altra: una faccia può essere
leggibile e l'altra muta, o le due facce possono provenire da fonti
fotografiche distinte. Il documento filologico che descrive una scheda
numismatica si articola pertanto in due parti strutturalmente
equivalenti, una per faccia, e lo stesso principio di derivazione
univoca già enunciato nella sezione 2 --- un solo documento sorgente,
dal quale ogni presentazione all'utente viene generata, e mai il
contrario --- si applica qui separatamente alle due metà della scheda.

Questa struttura a due facce si riflette direttamente sulla sezione
iconografica descritta nella sottosezione 5.1: ciascuna figura
descritta nel blocco dedicato all'iconografia porta ora l'indicazione
della faccia a cui appartiene, così che la descrizione del dritto e
quella del rovescio restino nettamente separate anche nella loro resa
in scheda, senza che questo richieda un vocabolario o un meccanismo di
analisi distinti da quelli già impiegati per il materiale epigrafico:
la falce lunare sulle spalle o il berretto frigio restano la stessa
chiave di vocabolario, semplicemente qualificata dalla faccia su cui
compaiono, e la heatmap delle co-occorrenze introdotta nella medesima
sottosezione continua a operare senza distinzioni sull'insieme più
ampio di chiavi che ne risulta.

Il vocabolario chiuso già adottato per l'iconografia (sottosezione 5.1)
si estende, con lo stesso principio di chiave sintetica accompagnata da
un'etichetta discorsiva in italiano, ai termini propri del materiale
numismatico --- zecca, autorità emittente (quella storicamente
accertata e quella dichiarata sulla legenda, che non sempre
coincidono), metallo, nominale, sistema ponderale, tecnica di
coniazione --- verificati caso per caso, dove possibile, contro
un'ontologia numismatica di riferimento consultabile in rete, che ha
permesso anche di registrare esplicitamente i pochi casi --- fra cui,
non senza un che di paradossale, il nome stesso del dio Men --- per i
quali quell'ontologia non prevede alcun identificativo, piuttosto che
forzarne uno di comodo o lasciare il termine privo di qualunque
riscontro esterno.

Come le altre sezioni del progetto, anche quella numismatica segue il
principio, già più volte richiamato in questo lavoro, per cui nessuna
informazione viene presentata come acquisita prima di essere stata
verificata: le schede sono state estratte in blocco dall'edizione a
stampa di riferimento e non hanno ancora attraversato la stessa
revisione capillare, voce per voce, già applicata al materiale
epigrafico. La sezione resta per il momento riservata alla redazione e
non compare né nello scatto statico consultabile dal pubblico né, di
conseguenza, nella navigazione, nella mappa, nella cronologia o negli
strumenti di ricerca destinati al lettore esterno: la sua pubblicazione
seguirà, e non anticiperà, la revisione sistematica delle singole voci.

\screenshotplaceholder{7.5cm}{Scheda di un tipo monetale, con dritto e rovescio affiancati e i rispettivi descrittori iconografici}

\screenshotplaceholder{7cm}{Elenco della sezione numismatica, con le voci ancora in redazione}
...
A fianco della ricerca descritta finora, che restituisce sempre schede
intere, è stata affiancata una modalità complementare pensata per chi
lavora direttamente sul testo piuttosto che sulla singola epigrafe: una
concordanza che restituisce, per un termine cercato, ciascuna occorrenza
nel proprio contesto immediato, con il segmento di testo che la precede
e quello che la segue, così da rendere visibili a colpo d'occhio le
formule ricorrenti --- un risultato che l'ordinamento per contesto, a
sinistra o a destra del termine cercato, rende ancora più evidente,
poiché avvicina fra loro occorrenze altrimenti sparse su schede
diverse. La concordanza condivide con la ricerca testuale libera la
stessa normalizzazione dei segni diacritici greci e la stessa
insensibilità a maiuscole e minuscole, e ricompone inoltre le parole
che nel testo trascritto restano spezzate da un'interruzione di riga,
così da non perdere le occorrenze che altrimenti cadrebbero a cavallo
di due righe distinte. I risultati possono essere filtrati per area
geografica ed esportati in un formato tabellare, per un'analisi che
prosegua fuori dall'interfaccia stessa.

\screenshotplaceholder{7cm}{Interfaccia del modulo di ricerca con filtri combinati}

\screenshotplaceholder{7cm}{Vista della concordanza, con le occorrenze disposte in contesto}
...
cultuale che le accomuna al materiale inciso sulla pietra.
...
che esso racconta. Si prevede infine di sottoporre anche la sezione
numismatica, descritta nella sottosezione 5.4 e per il momento
riservata alla redazione, alla stessa revisione sistematica, voce per
voce, già applicata al materiale epigrafico: solo al termine di questo
percorso, e non prima, la sezione potrà affiancarsi pubblicamente al
catalogo epigrafico.
