...
Un terzo intervento della stessa natura ha riguardato la descrizione del
supporto materiale, che in una prima stesura della codifica racchiudeva
in un unico campo di prosa libera due informazioni di natura diversa:
la caratterizzazione fisica del monumento --- già altrimenti tradotta,
per la parte quantitativa, nelle misure strutturate di altezza,
larghezza e profondità --- e le vicende del pezzo fra il momento del
rinvenimento e la sua condizione attuale, quali trasferimenti, passaggi
di collezione o perdita. Si è scelto di eliminare il campo di prosa
libera, che duplicava informazioni già codificate altrove senza
aggiungerne di proprie, e di isolare le vicende del monumento in un
attributo dedicato, distinto sia dal luogo di rinvenimento sia
dall'osservazione autoptica che già lo affiancavano nella scheda: una
distinzione che rispecchia, sul piano dei dati, quella già evidente sul
piano concettuale fra il luogo in cui un'epigrafe è stata trovata, ciò
che le è accaduto in seguito, e lo stato in cui si presenta a chi la
esamina oggi.
...
A sostegno di questo confronto sistematico con le fonti primarie è stato
messo a punto uno strumento dedicato di collazione, che confronta
automaticamente il testo greco trascritto in ciascuna scheda con una nuova
lettura ottica, del tutto indipendente, della pagina corrispondente
dell'edizione a stampa di riferimento. Coerentemente con il principio di
verificabilità più volte richiamato in questo lavoro, lo strumento non
scrive mai direttamente sul corpus: si limita a segnalare le divergenze
da verificare, lasciando alla decisione editoriale se e come intervenire
su ciascuna di esse.

La messa a punto di questo strumento ha richiesto di risolvere due
difficoltà specifiche del materiale. La prima riguarda il testo greco
dell'edizione a stampa, che nella sua rappresentazione digitale nativa
risultava spesso irriconoscibile --- ridotto a sequenze di caratteri privi
di senso da un processo di conversione pensato per il solo testo latino
--- cosicché il confronto non aveva, in partenza, nulla da collazionare sul
lato della fonte a stampa. Si è dovuto pertanto isolare, all'interno di
ciascuna pagina, i blocchi di testo effettivamente in caratteri greci,
distinguendoli dal testo inglese circostante sulla base di alcuni tratti
tipografici ricorrenti, e sottoporre soltanto quei blocchi a un
riconoscimento ottico dedicato. La seconda difficoltà riguarda
l'affidabilità del riconoscimento ottico in sé: una singola lettura
commette errori sistematici e non casuali --- una medesima lettera
confusa sistematicamente con la stessa lettera vicina nella grafia,
anziché con esiti imprevedibili --- che, se presi alla lettera,
farebbero apparire come divergenze dal testo a stampa fenomeni che sono
in realtà soltanto difetti di lettura ottica. Si è scelto pertanto di
produrre due letture indipendenti della medesima pagina, ottenute con
motori di riconoscimento ottico distinti e dunque soggetti a errori
sistematici differenti, e di segnalare una divergenza rispetto al corpus
soltanto quando entrambe le letture la confermano concordemente: se una
delle due coincide con il testo già presente in scheda, la divergenza
dell'altra è imputabile al riconoscimento ottico e non al dato
trascritto.

Applicato per la prima volta all'intero primo volume dell'edizione a
stampa, lo strumento ha permesso di rispondere in maniera quantitativa a
un dubbio più volte sollevato nel corso della revisione, ossia se una
parte consistente delle voci del corpus recasse errori di trascrizione
non ancora individuati: la maggioranza assoluta delle schede
confrontabili risulta coincidere esattamente con il testo a stampa, con
un livello di somiglianza complessivo molto elevato anche per le
restanti, ridimensionando un timore che, sulla sola base
dell'impressione qualitativa, sarebbe stato difficile confermare o
smentire. Lo strumento classifica inoltre le divergenze residue per
tipologia --- una singola lettera, un numerale, un intero blocco di testo
--- e raggruppa le sostituzioni ricorrenti tra le medesime coppie di
caratteri, cosicché un errore sistematico del riconoscimento ottico possa
essere corretto una volta per tutte come classe, anziché caso per caso.

Un ulteriore accorgimento, complementare a questo strumento di
collazione, riguarda la sincronizzazione dei dati tra l'ambiente di
lavoro quotidiano e il repository che ne conserva la versione di
riferimento: poiché un disallineamento silenzioso tra le due copie
rischierebbe di far scomparire, senza alcun avviso, schede già corredate
di correzioni filologiche, la procedura di sincronizzazione verifica ora
preventivamente l'entità delle differenze tra le due copie, e si arresta
segnalando il problema anziché procedere in automatico, qualora il
numero di schede che risulterebbero perse superi una soglia minima di
sicurezza.
...
Un ulteriore accorgimento, trasversale a tutte le sezioni descritte in
questo capitolo, riguarda la persistenza dello stato di navigazione: la
vista attualmente aperta e, quando pertinente, la singola scheda
selezionata vengono ora riportate nell'indirizzo della pagina, cosicché
un aggiornamento del browser, o l'invio dello stesso indirizzo a
un'altra persona, restituiscano esattamente lo stesso punto di
consultazione, anziché far ripartire la navigazione dalla schermata
iniziale. Si tratta di un accorgimento minore nella sua realizzazione,
ma che risolve un limite pratico non trascurabile per un progetto
pensato anche per un uso collaborativo, in cui il rimando diretto a una
scheda precisa --- per una verifica, per una discussione, per un
riferimento in altro contesto --- è un'esigenza ricorrente quanto quella
di rimando bibliografico già descritta poco sopra a proposito dei
repertori esterni.
...
tradizionali. Ogni voce, sfiorata durante lo scorrimento continuo della
pagina, aggiorna in tempo reale, come si dirà più diffusamente più
sotto, l'anteprima dei rispettivi epiteti nella colonna adiacente; un
click sulla stessa voce la fissa stabilmente in quell'anteprima, mentre
l'elenco delle epigrafi in cui il nome, o un particolare epiteto, è
attestato resta un passaggio volutamente distinto. La seconda vista
riguarda invece il
...
Lo scorrimento a sfioramento, per quanto efficace in una prima
ricognizione della rubrica, si scontrava con un problema pratico non
appena l'utente, individuata la divinità di interesse, dirigeva il
cursore verso la colonna di destra per raggiungere uno specifico
epiteto: il percorso del mouse attraversa inevitabilmente le voci
contigue della rubrica, e ciascuna di esse, aggiornando a sua volta
l'anteprima a ogni sfioramento, rischiava di sostituire la divinità
appena scelta con quella semplicemente attraversata di passaggio. Per
questo motivo il click su una voce della rubrica non segnala più un
interesse temporaneo, ma blocca stabilmente quella divinità
nell'anteprima, rendendo scorrimento e sfioramento successivi inerti
finché il blocco non viene rimosso --- con un nuovo click sulla stessa
voce, oppure con l'apposito comando di sblocco reso disponibile
nell'intestazione del pannello di anteprima; una nuova ricerca o un
cambio del filtro regionale annullano automaticamente il blocco,
poiché potrebbero escludere dalla rubrica la stessa divinità che era
stata fissata. L'elenco completo delle epigrafi resta raggiungibile
con un gesto distinto sulla radice dell'anteprima ad albero, cosicché
il passaggio dalla ricognizione d'insieme alla consultazione di una
singola epigrafe resti sempre una scelta intenzionale di chi consulta,
e non l'effetto collaterale di un movimento del mouse.
...
presentati con un'attestazione fittizia pari a zero. La lista dispone i
lemmi in forma di elenco navigabile, raggruppabile per famiglia tematica
o percorribile singolarmente per lemma, sullo stesso modello già
impiegato altrove nell'interfaccia per il registro onomastico e per la
bibliografia: non un grafico quantitativo, ma un indice da consultare. La
famiglia di appartenenza di ciascun lemma è segnalata da un piccolo
indicatore colorato affiancato al termine, anziché --- come in una prima
versione di questa vista --- da un colore applicato al testo stesso, una
scelta che privilegia la leggibilità della lista quando il numero di voci
cresce. Accanto al lemma compaiono il conteggio delle attestazioni, la
sotto-funzione specifica a cui è ricondotto e un rimando a uno strumento
lessicografico greco esterno per la sua consultazione, con accesso
diretto alle singole attestazioni, epigrafiche o letterarie, da cui il
conteggio deriva.

A questa classificazione per famiglia cultuale se ne è affiancata di
recente una seconda, del tutto indipendente dalla prima, mutuata da un
repertorio di analisi delle religioni antiche elaborato al di fuori del
progetto ILA. Se la famiglia risponde alla domanda su quale funzione
cultuale svolga una parola all'interno dell'atto religioso (un voto, una
dedica, una colpa da espiare), questa seconda classificazione risponde a
una domanda diversa: a quale genere di realtà appartenga ciò che la
parola designa, che si tratti di un agente divino, di un agente umano, di
un'azione, di un'istituzione, di uno spazio o di un oggetto materiale. Le
due letture convivono sulla stessa occorrenza marcata senza confondersi
--- una parola che designa un tempio, ad esempio, può condividere la
stessa famiglia cultuale di una che designa un voto, pur ricadendo in un
ramo completamente diverso di questa seconda classificazione --- ed è
proprio questa reciproca indipendenza a renderle, prese insieme, più
informative di quanto lo sarebbe ciascuna presa da sola. Come già per la
sotto-funzione descritta poco sopra, anche questo secondo percorso di
classificazione non è una scelta editoriale ulteriore: si deriva
automaticamente dal lemma, cosicché chi marca il testo continui a
rispondere a una sola domanda, quella della famiglia di appartenenza,
mentre il resto della classificazione viene calcolato dal sistema ---
lo stesso principio, già illustrato a proposito dello strumento di
marcatura nella sezione 3, per cui l'onere della codifica ricade il meno
possibile su chi la esegue materialmente.

Poiché lo schema completo di questa seconda classificazione distingue
categorie e sottocategorie in numero superiore a quelle di fatto
attestate nel corpus di Men, l'interfaccia elenca di norma soltanto i
percorsi che trovano effettivo riscontro nelle epigrafi, lasciando
dietro un comando esplicito la possibilità di rivelare anche i rami che
il corpus non ha ancora toccato: una scelta di presentazione, non di
sostanza, che permette comunque di non nascondere quanto lo schema
teorico preveda ma il materiale non attesti, coerentemente con il
principio, già richiamato a proposito della visualizzazione cronologica
(sezione 5), per cui l'assenza di un dato deve restare dichiarata e mai
indistinguibile da una lacuna dello strumento. Ogni ramo innestato in
questo schema per esigenze specifiche del corpus di Men, e non già
presente nel repertorio di origine, resta inoltre segnalato come tale,
così che chi consulta la griglia sappia sempre distinguere il nucleo
mutuato dal modello di riferimento dalle estensioni introdotte in sede
redazionale. Poiché la stessa struttura di classificazione è impiegata
anche negli indici della sezione dedicata alle fonti letterarie descritta
in apertura di questa sottosezione, l'interfaccia accosta a ciascun ramo,
oltre al conteggio delle attestazioni epigrafiche, il numero dei passi
letterari che vi fanno riferimento --- due conteggi tenuti sempre
distinti e mai sommati, secondo lo stesso principio già enunciato più
sopra per il lessico cultuale nel suo complesso ---, cosicché al
collegamento onomastico e divino con la sottosezione 5.2, già descritto
in apertura di questa sottosezione, se ne affianchi ora un secondo,
costruito sull'asse di questa classificazione condivisa.

Anche questo intero apparato lessicale --- famiglie, sotto-funzioni,
lemmi, rami della seconda classificazione --- è ora amministrato
attraverso lo stesso meccanismo di vocabolario aperto già descritto a
proposito della sezione iconografica (sottosezione 5.1): chi dispone dei
permessi di modifica può correggere o ampliare qualunque componente del
vocabolario senza dover intervenire sullo schema di codifica sottostante.
Lo strumento assistito di marcatura filologica (sezione 3) ne beneficia
direttamente: nel marcare una parola del lessico cultuale, o un'entità
classificata direttamente secondo la seconda classificazione, propone ora
menu di selezione strutturati costruiti su questo stesso vocabolario, al
posto della digitazione libera degli attributi corrispondenti, riducendo
ulteriormente il rischio di introdurre, per semplice errore di battitura,
un valore estraneo al vocabolario condiviso.

\screenshotplaceholder{8cm}{Indice delle voci della sezione dedicata alle fonti letterarie}

\screenshotplaceholder{7.5cm}{Elenco del lessico cultuale, con la seconda classificazione e attestazioni epigrafiche e letterarie a confronto}
...
un lavoro che, come illustrato nella sezione 4, dispone ora di uno
strumento automatico di collazione capace di orientarne le priorità, e i
cui primi risultati quantitativi confermano l'affidabilità complessiva
delle trascrizioni già presenti nel corpus.
